...
public class OfferAnDto {
    ...
    public OfferAnDto(String id, String numberOffer, String nameOffer, String nameTrader, String nameTeam, String client,
    ...
    public String getWhoCreate() {return whoCreate;}
